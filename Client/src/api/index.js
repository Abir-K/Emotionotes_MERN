...
export const fetchPost = (id) => API.get(`/posts/getDetails/${id}`);
export const fetchPosts = (page) => API.get(`/posts/allPost?page=${page}`);
...
export const comment = (value, id) => API.post(`/posts/comment/${id}/commentPost`, { value });
